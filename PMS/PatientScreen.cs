...
namespace PMS
{
    public partial class PatientScreen : Form
    {
        ...
        private void PatientScreenLoad(object sender, EventArgs e)
        {
            ...
            guna2DataGridView1.Columns[3].Width = 65; // Adjust the desired width value

            // Change the width of the gender column
            guna2DataGridView1.Columns[4].Width = 85; // Adjust the desired width value

            // Change the width of the blood column
            guna2DataGridView1.Columns[5].Width = 80; // Adjust the desired width value

            // Change the width of the weight column
            guna2DataGridView1.Columns[6].Width = 80; // Adjust the desired width value

            // Change the width of the height column
            guna2DataGridView1.Columns[7].Width = 80; // Adjust the desired width value
